...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Smileys app" },
      { name: "mobile-web-app-capable", content: "yes" },
      { title: "Smileys app — Livestock, Feed, Garden & Finances" },
      { name: "description", content: "Smileys app helps track livestock, breeding, feed inventory, gardens, compost, barter trades, finances, and daily homestead life in one place." },
      { property: "og:title", content: "Smileys app — Livestock, Feed, Garden & Finances" },
      { name: "twitter:title", content: "Smileys app — Livestock, Feed, Garden & Finances" },
      { property: "og:description", content: "Smileys app helps track livestock, breeding, feed inventory, gardens, compost, barter trades, finances, and daily homestead life in one place." },
      { name: "twitter:description", content: "Smileys app helps track livestock, breeding, feed inventory, gardens, compost, barter trades, finances, and daily homestead life in one place." },
