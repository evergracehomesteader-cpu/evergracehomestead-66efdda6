...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EverGrace Homestead — Livestock, Feed, Garden & Finances" },
      { name: "description", content: "EverGrace Homestead helps track livestock, breeding, feed inventory, gardens, compost, barter trades, finances, and daily homestead life in one place." },
      { property: "og:title", content: "EverGrace Homestead — Livestock, Feed, Garden & Finances" },
      { name: "twitter:title", content: "EverGrace Homestead — Livestock, Feed, Garden & Finances" },
      { property: "og:description", content: "EverGrace Homestead helps track livestock, breeding, feed inventory, gardens, compost, barter trades, finances, and daily homestead life in one place." },
      { name: "twitter:description", content: "EverGrace Homestead helps track livestock, breeding, feed inventory, gardens, compost, barter trades, finances, and daily homestead life in one place." },
