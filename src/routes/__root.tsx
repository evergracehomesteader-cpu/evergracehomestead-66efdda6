...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Homestead Hub" },
      { name: "mobile-web-app-capable", content: "yes" },
      { title: "Homestead Hub — Livestock, Feed, Garden & Finances" },
      { name: "description", content: "Homestead Hub helps track livestock, breeding, feed inventory, gardens, compost, barter trades, finances, and daily homestead life in one place." },
      { property: "og:title", content: "Homestead Hub — Livestock, Feed, Garden & Finances" },
      { name: "twitter:title", content: "Homestead Hub — Livestock, Feed, Garden & Finances" },
      { property: "og:description", content: "Homestead Hub helps track livestock, breeding, feed inventory, gardens, compost, barter trades, finances, and daily homestead life in one place." },
      { name: "twitter:description", content: "Homestead Hub helps track livestock, breeding, feed inventory, gardens, compost, barter trades, finances, and daily homestead life in one place." },
